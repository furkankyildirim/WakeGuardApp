...
import { API_KEY, AUTOCOMPLETE_API, GEOCODING_API, } from '../assets/store/GoogleAPI'
...
export default class SearchScreen extends Component {
  ...
  showResults = value => {
    value !== '' ? this.setState({ search: value }) : this.setState({ search: value, predictions: '' })
  }
    ...
    return (
      <TouchableOpacity style={[styles.listItem]} key={item.place_id} onPress={async () => [
        ...
        <View style={styles.listItemTextContainer}>
          <Text numberOfLines={1} style={styles.listItemTitle}>{item.structured_formatting.main_text}</Text>
          <Text numberOfLines={1} style={styles.listItemText}>{item.structured_formatting.secondary_text}</Text>
        </View>
      </TouchableOpacity>
    )
  }
    ...
    return (
      <SafeAreaView style={styles.mainContainer}>
        <View style={styles.topComponent}>
          <TouchableOpacity onPress={() => this.props.navigation.navigate("Home")} style={styles.menuButton}>
            ...
            <View style={styles.chooseDestinationContainer}>
              <View style={styles.locationInput}>
                ...
                <TextInput
                  ...
                  onChangeText={value => [this.showResults(value), this.getPlaces(value)]}
                />
              </View>
            </View>
          </View>
